...
const createCategory = (categoryData, file) => __awaiter(void 0, void 0, void 0, function* () {
    const uploadedCategoryImage = yield FileUploadHelper_1.FileUploadHelper.uploadToCloudinary(file);
    if (!uploadedCategoryImage) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Image upload failed');
    }
    const result = yield prisma_1.default.category.create({
        data: Object.assign(Object.assign({}, categoryData), { categoryImg: uploadedCategoryImage.secure_url }),
        include: {
            Service: true,
        },
    });
